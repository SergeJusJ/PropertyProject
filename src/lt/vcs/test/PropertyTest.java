...
import lt.vcs.property.Flat;
import lt.vcs.property.Property;
import lt.vcs.property.PropertyType;
...
/*
    ...
    void testCreatedPropertyClass() {
        ...
        assertEquals(false, prop.getArea() == 50);
...
*/
    ...
    void testFlatHasRoomsAndDscrpt() {
        ...
        assertEquals(
                "This is a 4 rooms flat." +
                        "The property is in Alytus, it costs 60500.0 Eur, the area is 87.0 square meters",
                description);
    }
...
//Testing reading from file
    ...
    void testMyFileReader() {
        MyFileReader mfr = new MyFileReader(true);
        assertFalse(mfr.getProperty().isEmpty());
    }
